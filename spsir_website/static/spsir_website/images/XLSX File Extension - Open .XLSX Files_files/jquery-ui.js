...
// Show/hide info popups on extension pages.
$(document).ready(function() {
	$('div[id^="txtinfo_"]').hide();
	$('a[id^="txt_"]').click(function(event){
		event.preventDefault();
		// stops propagation to the document body, used when html.click(function()) is clicked
	...
	// triggers when clicked anywhere on the page
	$('html').click(function() {
		//Hide txtinfo divs if visible
		$('div[id^="txtinfo_"]').hide();
	});
});
